...
class InsuranceEnrollView extends GetView<InsuranceEnrollController> {
  const InsuranceEnrollView({super.key});
  @override
...
class ContentView extends GetView<InsuranceEnrollController> {
