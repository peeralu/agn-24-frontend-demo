...
class InsuranceDetailView extends GetView<InsuranceDetailController> {
  const InsuranceDetailView({super.key});
  @override
...
class ContentView extends GetView<InsuranceDetailController> {
